...
describe GuidesController do
  ...
  describe "GET new" do
    it "assigns a new guide as @guide" do
      ...
      assigns(:guide).should be_a_new(Guide)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created guide as @guide" do
        post :create, {:guide => valid_attributes}, valid_session
        assigns(:guide).should be_a(Guide)
        assigns(:guide).should be_persisted
      end

      it "redirects to the created guide" do
        post :create, {:guide => valid_attributes}, valid_session
        response.should redirect_to(Guide.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved guide as @guide" do
        ...
        Guide.any_instance.stub(:save).and_return(false)
        post :create, {:guide => {}}, valid_session
        assigns(:guide).should be_a_new(Guide)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested guide" do
        ...
        Guide.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, {:id => guide.to_param, :guide => {'these' => 'params'}}, valid_session
      end
      ...
      it "redirects to the guide" do
        guide = Guide.create! valid_attributes
        put :update, {:id => guide.to_param, :guide => valid_attributes}, valid_session
        response.should redirect_to(guide)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the guide as @guide" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Guide.any_instance.stub(:save).and_return(false)
        put :update, {:id => guide.to_param, :guide => {}}, valid_session
        assigns(:guide).should eq(guide)
      end
